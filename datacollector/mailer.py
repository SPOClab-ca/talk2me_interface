...
email_username = Settings.objects.get(setting_name="system_email")
email_password = Settings.objects.get(setting_name="system_email_passwd")
website_hostname = Settings.objects.get(setting_name="website_hostname")
