                    ...
                    if date_last_access:
                        ...
                        if delta >= 0:
                            if delta % user_pref_freq == 0:
                                ...
                                email_text = "Dear <b>%s</b>, \r\n\r\nIt's time for your next session on %s! When you are ready for some new language puzzles, <a href='%s'>click here</a>. Your participation in this project is important to us, and directly helps enable research into language pattern changes over time.\r\n\r\n- The SPOClab team!\r\n\r\nSPOClab: The Signal Processing and Oral Communication lab\r\n550 University Avenue, 12-175\r\nToronto, Ontario M5G 2A2\r\n<a href='http://spoclab.ca'>http://spoclab.ca</a>\r\n\r\nIf you wish to unsubscribe from such emails in the future, please visit <a href='%s'>your Account Settings page</a>." % (username, website_name, website_hostname, website_hostname + '/account')
                                email_html = "<h3>Dear %s, it's time for your next session on %s!</h3><p>When you are ready for some new language puzzles, <a href='%s'>click here</a>. Your participation in this project is important to us, and directly helps enable research into language pattern changes over time.</p><p>- The SPOClab team</p><hr /><p>SPOClab: The Signal Processing and Oral Communication lab<br />550 University Avenue, 12-175, Toronto, Ontario M5G 2A2<br /><a href='http://spoclab.ca'>http://spoclab.ca</a></p><p>If you wish to unsubscribe from such emails in the future, please visit <a href='%s'>your Account Settings page</a>.</p>" % (username, website_name, website_hostname, website_hostname + '/account')
